...
var ctrl = {
    ...
    contador: function(id){
        let eCont = $("#eContador"+id).val();
        eCont++;
        $("#bClick"+id).html(eCont);
        $("#eContador"+id).val(eCont);
    },
    ...
    guardar: function(){
        ...
        if(!$("#tNombre").val()){
            bBandera = true;
            $("#tNombre").parent().addClass('has-error');
        }else{
            bBandera = false;
            $("#tNombre").parent().removeClass('has-error');
        }
        if(bBandera == true){
            ...
            $.ajax({type: "POST",
                url: "../modelo/oper/tare-reg-data.php",
                data: {tNombre: $("#tNombre").val()},
